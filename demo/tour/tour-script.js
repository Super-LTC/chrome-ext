...
const CHAPTER_3 = [
  ...
  },
  {
    ...
    placement: 'top',
    title: 'The note is already written',
    body: "Super drafted the clarification note with the chart evidence attached — nothing to type. Click Next to choose who signs it.",
    advance: 'click',
  },
  {
    id: 'c3-pick',
    ...
    body: 'Choose the physician who should sign off. Click their name.',
    advance: 'click',
  },
  {
    id: 'c3-send',
    ...
    placement: 'top',
    title: 'Send it',
    body: 'Hit Send — the doctor gets a text (and email) instantly. No phone calls, no faxes.',
    advance: 'event',
